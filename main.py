...
#                         print(f'№: {_documents["number"]}, тип: {_documents["type"]}, владелец: {_documents["name"]}, полка хранения: {key}')
#
#         get_all_info()
#
#     if command == 'ads':
...
#                 return 'Такая полка уже существует. Текущий перечень полок: ' + ', '.join(str(i) for i in directories.keys())
#             else:
...
#                 return 'На полке есть документы, удалите их перед удалением полки. Текущий перечень полок: ' + ', '.join(str(i) for i in directories.keys())
#             else:
#                 if directories.get(_number) is None:
#                     return 'Такой полки не существует. Текущий перечень полок: ' + ', '.join(str(i) for i in directories.keys())
#
